...
selections: [account_disable_post_pw_expiration, accounts_have_homedir_login_defs,
    ...
    accounts_minimum_age_login_defs, accounts_no_uid_except_zero, accounts_password_all_shadowed,
    ...
    accounts_password_pam_minclass, accounts_password_pam_minlen, accounts_password_pam_ocredit,
    accounts_password_pam_retry, accounts_password_pam_ucredit, accounts_password_pam_unix_remember,
    accounts_password_set_max_life_existing, accounts_password_set_min_life_existing,
    accounts_password_warn_age_login_defs, accounts_passwords_pam_faillock_deny, accounts_passwords_pam_faillock_deny_root,
    accounts_passwords_pam_faillock_interval, accounts_passwords_pam_faillock_unlock_time,
    accounts_tmout, accounts_umask_etc_login_defs, accounts_umask_interactive_users,
    accounts_user_dot_group_ownership, accounts_user_dot_no_world_writable_programs,
    accounts_user_dot_user_ownership, accounts_user_home_paths_only, accounts_user_interactive_home_directory_defined,
    accounts_user_interactive_home_directory_exists, accounts_users_home_files_groupownership,
    accounts_users_home_files_ownership, accounts_users_home_files_permissions, aide_build_database,
    aide_periodic_cron_checking, aide_scan_notification, aide_use_fips_hashes, aide_verify_acls,
    ...
    audit_rules_execution_semanage, audit_rules_execution_setfiles, audit_rules_execution_setsebool,
    audit_rules_file_deletion_events, audit_rules_file_deletion_events_rename, audit_rules_file_deletion_events_renameat,
    audit_rules_file_deletion_events_rmdir, audit_rules_file_deletion_events_unlink,
    audit_rules_file_deletion_events_unlinkat, audit_rules_immutable, audit_rules_kernel_module_loading_delete,
    audit_rules_kernel_module_loading_finit, audit_rules_kernel_module_loading_init,
    ...
    auditd_audispd_syslog_plugin_activated, auditd_data_retention_action_mail_acct,
    auditd_data_retention_admin_space_left_action, auditd_data_retention_flush, auditd_data_retention_max_log_file,
    auditd_data_retention_max_log_file_action, auditd_data_retention_num_logs, auditd_data_retention_space_left,
    auditd_data_retention_space_left_action, banner_etc_issue, chronyd_or_ntpd_set_maxpoll,
    chronyd_or_ntpd_specify_multiple_servers, chronyd_or_ntpd_specify_remote_server,
    clean_components_post_updating, configure_firewalld_ports, configure_opensc_card_drivers,
    configure_opensc_nss_db, dir_perms_world_writable_system_owned, disable_ctrlaltdel_burstaction,
    disable_ctrlaltdel_reboot, disable_host_auth, disable_prelink, display_login_attempts,
    encrypt_partitions, ensure_gpgcheck_globally_activated, ensure_gpgcheck_local_packages,
    ensure_gpgcheck_never_disabled, ensure_redhat_gpgkey_installed, file_groupowner_cron_allow,
    file_groupowner_grub2_cfg, file_groupownership_home_directories, file_owner_cron_allow,
    file_owner_grub2_cfg, file_ownership_home_directories, file_ownership_var_log_audit,
    file_permission_user_init_files, file_permissions_grub2_cfg, file_permissions_home_directories,
    ...
    gid_passwd_group_same, grub2_audit_argument, grub2_disable_interactive_boot, grub2_enable_fips_mode,
    grub2_enable_selinux, grub2_no_removeable_media, grub2_password, grub2_uefi_password,
    install_PAE_kernel_on_x86-32, install_antivirus, install_hids, installed_OS_is_FIPS_certified,
    ...
    kernel_module_jffs2_disabled, kernel_module_sctp_disabled, kernel_module_usb-storage_disabled,
    ldap_client_start_tls, libreswan_approved_tunnels, mount_option_home_nosuid, mount_option_nodev_remote_filesystems,
    mount_option_nodev_removable_partitions, mount_option_noexec_remote_filesystems,
    mount_option_noexec_removable_partitions, mount_option_nosuid_remote_filesystems,
    mount_option_nosuid_removable_partitions, network_configure_name_resolution, network_ipv6_disable_rpc,
    network_ipv6_privacy_extensions, network_sniffer_disabled, no_direct_root_logins,
    no_empty_passwords, no_files_unowned_by_user, no_host_based_files, no_rsh_trust_files,
    no_user_host_based_files, package_aide_installed, package_dracut-fips_installed,
    package_gdm_removed, package_opensc_installed, package_openssh-server_installed,
    ...
    package_telnet_removed, package_tftp-server_removed, package_vsftpd_removed, package_xinetd_removed,
    package_xorg-x11-server-common_removed, package_ypbind_removed, package_ypserv_removed,
    partition_for_home, partition_for_tmp, partition_for_var, partition_for_var_log_audit,
    require_singleuser_auth, restrict_serial_port_logins, rpm_verify_hashes, rpm_verify_ownership,
    rpm_verify_permissions, rsyslog_cron_logging, rsyslog_nolisten, rsyslog_remote_loghost,
    sebool_abrt_anon_write, sebool_abrt_handle_event, sebool_abrt_upload_watch_anon_write,
    sebool_auditadm_exec_content, sebool_cron_can_relabel, sebool_cron_system_cronjob_use_shares,
    sebool_cron_userdomain_transition, sebool_daemons_dump_core, sebool_daemons_use_tcp_wrapper,
    sebool_daemons_use_tty, sebool_deny_execmem, sebool_deny_ptrace, sebool_domain_fd_use,
    sebool_domain_kernel_load_modules, sebool_fips_mode, sebool_gpg_web_anon_write,
    sebool_guest_exec_content, sebool_kerberos_enabled, sebool_logadm_exec_content,
    sebool_logging_syslogd_can_sendmail, sebool_logging_syslogd_use_tty, sebool_login_console_enabled,
    sebool_mmap_low_allowed, sebool_mock_enable_homedirs, sebool_mount_anyfile, sebool_polyinstantiation_enabled,
    sebool_secadm_exec_content, sebool_secure_mode, sebool_secure_mode_insmod, sebool_secure_mode_policyload,
    ...
    service_autofs_disabled, service_bluetooth_disabled, service_chronyd_or_ntpd_enabled,
    service_crond_enabled, service_debug-shell_disabled, service_firewalld_enabled,
    service_kdump_disabled, service_pcscd_enabled, service_rexec_disabled, service_rlogin_disabled,
    ...
    sssd_enable_smartcards, sssd_memcache_timeout, sssd_offline_cred_expiration, sssd_ssh_known_hosts_timeout,
    sudo_remove_no_authenticate, sudo_vdsm_nopasswd, sysctl_fs_suid_dumpable, sysctl_kernel_dmesg_restrict,
    ...
    sysctl_net_ipv6_conf_default_accept_source_route, tftpd_uses_secure_mode, use_kerberos_security_all_exports,
    wireless_disable_interfaces, var_password_pam_minclass=4, var_password_pam_maxrepeat=3,
    var_accounts_user_umask=077, sysctl_net_ipv6_conf_all_accept_source_route_value=disabled,
    var_account_disable_post_pw_expiration=35, sysctl_net_ipv4_conf_all_accept_source_route_value=disabled,
    var_selinux_policy_name=targeted, var_password_pam_ocredit=1, var_password_pam_dcredit=1,
    var_auditd_space_left_action=email, var_auditd_flush=data, var_password_pam_minlen=15,
    sshd_required=yes, var_accounts_passwords_pam_faillock_fail_interval=900, var_auditd_max_log_file_action=rotate,
    var_accounts_fail_delay=4, var_password_pam_difok=8, var_accounts_minimum_age_login_defs=7,
    sysctl_net_ipv4_conf_default_accept_redirects_value=disabled, var_accounts_passwords_pam_faillock_unlock_time=never,
    var_accounts_password_warn_age_login_defs=7, var_password_pam_maxclassrepeat=4,
    sysctl_net_ipv4_tcp_syncookies_value=enabled, sysctl_net_ipv4_icmp_echo_ignore_broadcasts_value=enabled,
    var_time_service_set_maxpoll=system_default, sysctl_net_ipv4_conf_all_accept_redirects_value=disabled,
    var_password_pam_lcredit=1, var_auditd_action_mail_acct=root, var_multiple_time_servers=rhel,
    ...
    var_removable_partition=dev_cdrom, var_sssd_ssh_known_hosts_timeout=5_minutes,
    var_auditd_num_logs=5, sysctl_net_ipv4_conf_default_accept_source_route_value=disabled,
    var_selinux_state=enforcing, var_password_pam_unix_remember=5, var_smartcard_drivers=cac,
