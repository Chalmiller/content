...
selections: [ensure_gpgcheck_globally_activated, ensure_gpgcheck_local_packages, ensure_gpgcheck_never_disabled,
    ensure_redhat_gpgkey_installed, package_dhcp_removed, package_rsyslog_installed,
    package_sendmail_removed, package_telnetd_removed, security_patches_up_to_date,
    service_rsyslog_enabled, set_password_hashing_algorithm_logindefs, sudo_remove_no_authenticate,
