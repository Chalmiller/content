...
selections: [accounts_tmout, accounts_umask_etc_login_defs, accounts_umask_etc_profile,
    ensure_gpgcheck_globally_activated, ensure_gpgcheck_local_packages, ensure_gpgcheck_never_disabled,
    ...
    file_permissions_unauthorized_sgid, file_permissions_unauthorized_suid, grub2_password,
    grub2_uefi_password, mount_option_home_nodev, mount_option_home_nosuid, mount_option_tmp_nodev,
    mount_option_tmp_noexec, mount_option_tmp_nosuid, mount_option_var_tmp_nodev,
    mount_option_var_tmp_noexec, mount_option_var_tmp_nosuid, no_direct_root_logins,
    package_dhcp_removed, package_rsyslog_installed, package_sendmail_removed, package_telnetd_removed,
    partition_for_home, partition_for_tmp, partition_for_var, partition_for_var_log,
    partition_for_var_tmp, rsyslog_files_groupownership, rsyslog_files_ownership,
    ...
    sysctl_net_ipv4_conf_all_accept_redirects_value=disabled, var_accounts_user_umask=077,
    sysctl_net_ipv4_conf_default_accept_redirects_value=disabled, sshd_idle_timeout_value=5_minutes]
