...
selections: [account_disable_post_pw_expiration, accounts_maximum_age_login_defs,
    ...
    accounts_password_pam_maxrepeat, accounts_password_pam_minlen, accounts_password_pam_ocredit,
    accounts_password_pam_ucredit, accounts_password_pam_unix_remember, accounts_passwords_pam_faillock_deny,
    accounts_passwords_pam_faillock_deny_root, accounts_passwords_pam_faillock_interval,
    accounts_passwords_pam_faillock_unlock_time, audit_rules_dac_modification_chmod,
    ...
    audit_rules_privileged_commands_gpasswd, audit_rules_privileged_commands_newgrp,
    audit_rules_privileged_commands_pam_timestamp_check, audit_rules_privileged_commands_passwd,
    ...
    audit_rules_privileged_commands_sudo, audit_rules_privileged_commands_sudoedit,
    ...
    audit_rules_usergroup_modification_shadow, banner_etc_issue, clean_components_post_updating,
    configure_opensc_card_drivers, configure_opensc_nss_db, disable_host_auth, ensure_gpgcheck_globally_activated,
    ensure_gpgcheck_local_packages, ensure_gpgcheck_never_disabled, ensure_redhat_gpgkey_installed,
    file_ownership_var_log_audit, file_permissions_sshd_private_key, file_permissions_sshd_pub_key,
    file_permissions_var_log_audit, force_opensc_card_drivers, grub2_audit_argument,
    grub2_disable_interactive_boot, grub2_enable_fips_mode, grub2_enable_selinux,
    grub2_password, grub2_uefi_password, installed_OS_is_FIPS_certified, installed_OS_is_vendor_supported,
    kernel_module_bluetooth_disabled, kernel_module_usb-storage_disabled, no_direct_root_logins,
    no_empty_passwords, no_password_auth_for_systemaccounts, package_opensc_installed,
    package_pcsc-lite_installed, require_singleuser_auth, restrict_serial_port_logins,
    rpm_verify_hashes, rpm_verify_ownership, rpm_verify_permissions, sebool_fips_mode,
    securetty_root_login_console_only, selinux_confinement_of_daemons, selinux_policytype,
    selinux_state, service_auditd_enabled, service_bluetooth_disabled, service_pcscd_enabled,
    set_password_hashing_algorithm_libuserconf, set_password_hashing_algorithm_logindefs,
    set_password_hashing_algorithm_systemauth, sshd_allow_only_protocol2, sshd_disable_compression,
    sshd_disable_empty_passwords, sshd_disable_gssapi_auth, sshd_disable_kerb_auth,
    sshd_disable_rhosts_rsa, sshd_disable_root_login, sshd_do_not_permit_user_env,
    sshd_enable_strictmodes, sshd_enable_warning_banner, sshd_print_last_log, sshd_set_idle_timeout,
    sshd_set_keepalive, sshd_set_loglevel_info, sshd_use_approved_ciphers, sshd_use_approved_macs,
    sshd_use_priv_separation, sssd_enable_smartcards, sysctl_kernel_exec_shield, sysctl_kernel_kptr_restrict,
    sysctl_kernel_randomize_va_space, var_accounts_passwords_pam_faillock_deny=3,
    var_smartcard_drivers=cac, var_accounts_passwords_pam_faillock_fail_interval=900,
    var_accounts_passwords_pam_faillock_unlock_time=never]
title: VPP - Protection Profile for Virtualization v. 1.0 for Red Hat Enterprise Linux
    Hypervisor (RHELH)
