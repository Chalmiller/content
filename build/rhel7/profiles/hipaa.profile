...
selections: [audit_rules_dac_modification_chmod, audit_rules_dac_modification_chown,
    audit_rules_dac_modification_fchmod, audit_rules_dac_modification_fchmodat, audit_rules_dac_modification_fchown,
    audit_rules_dac_modification_fchownat, audit_rules_dac_modification_fremovexattr,
    ...
    audit_rules_execution_semanage, audit_rules_execution_setsebool, audit_rules_file_deletion_events_rename,
    ...
    audit_rules_immutable, audit_rules_kernel_module_loading_delete, audit_rules_kernel_module_loading_init,
    ...
    auditd_data_retention_flush, dconf_db_up_to_date, dconf_gnome_remote_access_credential_prompt,
    dconf_gnome_remote_access_encryption, disable_ctrlaltdel_burstaction, disable_ctrlaltdel_reboot,
    disable_host_auth, encrypt_partitions, ensure_gpgcheck_globally_activated, ensure_gpgcheck_local_packages,
    ensure_gpgcheck_never_disabled, ensure_redhat_gpgkey_installed, file_groupowner_grub2_cfg,
    file_owner_grub2_cfg, file_permissions_grub2_cfg, grub2_audit_argument, grub2_disable_interactive_boot,
    grub2_enable_selinux, grub2_password, grub2_uefi_password, kernel_module_usb-storage_disabled,
    libreswan_approved_tunnels, no_direct_root_logins, no_empty_passwords, no_rsh_trust_files,
    package_rsh-server_removed, package_rsh_removed, package_talk-server_removed,
    package_talk_removed, package_telnet-server_removed, package_telnet_removed, package_xinetd_removed,
    package_ypbind_removed, package_ypserv_removed, require_singleuser_auth, restrict_serial_port_logins,
    rpm_verify_hashes, rpm_verify_permissions, rsyslog_remote_loghost, sebool_selinuxuser_execheap,
    sebool_selinuxuser_execmod, sebool_selinuxuser_execstack, securetty_root_login_console_only,
    selinux_confinement_of_daemons, selinux_policytype, selinux_state, service_auditd_enabled,
    service_autofs_disabled, service_crond_enabled, service_debug-shell_disabled,
    service_kdump_disabled, service_rexec_disabled, service_rlogin_disabled, service_rsh_disabled,
    service_telnet_disabled, service_xinetd_disabled, service_ypbind_disabled, service_zebra_disabled,
    ...
    sshd_set_keepalive, sshd_use_approved_ciphers, sshd_use_approved_macs, sysctl_fs_suid_dumpable,
    sysctl_kernel_dmesg_restrict, sysctl_kernel_exec_shield, sysctl_kernel_randomize_va_space,
    use_kerberos_security_all_exports, var_selinux_state=enforcing, var_selinux_policy_name=targeted]
