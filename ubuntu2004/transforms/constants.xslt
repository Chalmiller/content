...
<xsl:variable name="product_short_name">U2004</xsl:variable>
<xsl:variable name="product_stig_id_name">UBUNTU_STIG</xsl:variable>
<xsl:variable name="product_guide_id_name">UBUNTU-2004</xsl:variable>
<xsl:variable name="prod_type">ubuntu2004</xsl:variable>

<!-- Define URI of official Center for Internet Security Benchmark for Ubuntu 2004 -->
